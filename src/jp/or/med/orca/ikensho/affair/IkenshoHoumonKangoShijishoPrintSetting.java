...
//                        .get("MT_STS")), 100));
        ...
        switch (((Integer) VRBindPathParser.get("YOUKAIGO_JOUKYOU", data))
                .intValue()) {
        case 1: // 自立
            pd.addAttribute("Label29", "Visible", "FALSE"); //要支援１
            pd.addAttribute("Label30", "Visible", "FALSE"); //要支援２
            pd.addAttribute("Shape54", "Visible", "FALSE"); //要介護１
            pd.addAttribute("Shape9", "Visible", "FALSE"); //要介護２
            pd.addAttribute("Shape51", "Visible", "FALSE"); //要介護３
            pd.addAttribute("Shape52", "Visible", "FALSE"); //要介護４
            pd.addAttribute("Shape53", "Visible", "FALSE"); //要介護５
            break;
        case 10:// 要支援１
            pd.addAttribute("Label30", "Visible", "FALSE"); //要支援２
            pd.addAttribute("Shape54", "Visible", "FALSE"); //要介護１
...
//        }
    ...
    public static void printShijishoMulti(
        ...
        switch (((Integer) VRBindPathParser.get("YOUKAIGO_JOUKYOU", data))
                .intValue()) {
        case 1: // 自立
            pd.addAttribute("Label3", "Visible", "FALSE"); //要支援１
            pd.addAttribute("Label4", "Visible", "FALSE"); //要支援２
            pd.addAttribute("Shape54", "Visible", "FALSE"); //要介護１
            pd.addAttribute("Shape9", "Visible", "FALSE"); //要介護２
            pd.addAttribute("Shape51", "Visible", "FALSE"); //要介護３
            pd.addAttribute("Shape52", "Visible", "FALSE"); //要介護４
