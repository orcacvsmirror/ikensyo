...
/** TODO <HEAD_IKENSYO> */
public class IkenshoRenkeiIJyouhouIchiran extends IkenshoAffairContainer implements ACAffairable {
    ...
    private static final ACPassiveKey PASSIVE_CHECK_KEY = new
        ACPassiveKey("RENKEII", new String[] {"RENKEII_CD"}
                          , new Format[] {null}, "LAST_TIME", "LAST_TIME");

    /**
     * コンストラクタです。
     */
    public IkenshoRenkeiIJyouhouIchiran() {
        super();
...
//        this.setBackground(IkenshoConstants.FRAME_BACKGROUND);
        ...
        detail.setToolTipText("選択された連携医情報の詳細画面へ移ります。");
        ...
        insert.setToolTipText("連携医情報を新規に作成します。");
        ...
        delete.setToolTipText("選択された連携医情報を削除します。");
...
//      return table.getTable();
    ...
    protected void detailActionPerformed(ActionEvent e) throws Exception {
        ...
        //遷移
        ACAffairInfo affair = new ACAffairInfo(IkenshoRenkeiIJyouhouShousai.class.
                                                 getName(), selectedRow, "連携医情報詳細");
    ...
    protected void deleteActionPerformed(ActionEvent e) throws Exception {
        ...
        if (result == ACMessageBox.RESULT_OK) {
            ...
            try {
                ...
                //選択行の連携医コードを取得
                String renkeiiCd = String.valueOf(((VRMap)data.get(row)).getData("RENKEII_CD"));

                //SQL文の生成
                String sql = "DELETE FROM RENKEII WHERE RENKEII_CD=" + renkeiiCd;
