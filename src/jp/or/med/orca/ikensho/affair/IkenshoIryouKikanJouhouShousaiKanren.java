...
public class IkenshoIryouKikanJouhouShousaiKanren extends
    ...
    private void jbInit() throws Exception {
        ...
        // [ID:0000602][Masahiko Higuchi] 2010/02 del begin 診療報酬単価の変更対応
...
//                new VRTableColumn(3, 150, "事業所番号") }));
        		 new VRTableColumn(0, 180, "保険者番号"),
                 new VRTableColumn(1, 450, "保険者名称"),
                 new VRTableColumn(2, 240, "保険者区分", IkenshoInsurerTypeFormat.getInstance()),
                 new VRTableColumn(3, 240, "事業所番号") }));
    }
