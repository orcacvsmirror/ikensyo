...
//                                        IkenshoConstants.FORMAT_ERA_YMD,
//                                        tableCellRenderer, null) }));
                                new ACTableColumn(0, 85, "発行済",
                                        SwingConstants.CENTER,
                                        IkenshoSeikyushoHakkouKubunReserveFormat
                                                .getInstance()),
                                new ACTableColumn(1, 150, "区分", IkenshoFormatTypeFormat.getInstance()),
                                new ACTableColumn(2, 180, "氏名",
                                        tableCellRenderer, null),
                                new ACTableColumn(3, 60, "年齢",
                                        SwingConstants.RIGHT,
                                        tableCellRenderer, null),
                                new ACTableColumn(4, 320, "被保険者番号／受給者番号",
                                        tableCellRenderer, null),
                                new ACTableColumn(5, 180, "医師氏名",
                                        tableCellRenderer, null),
                                new ACTableColumn(6, 220, "作成依頼日",
                                        IkenshoConstants.FORMAT_ERA_YMD,
                                        tableCellRenderer, null),
                                new ACTableColumn(7, 220, "意見書記入日",
                                        IkenshoConstants.FORMAT_ERA_YMD,
                                        tableCellRenderer, null),
                                new ACTableColumn(8, 200, "意見書送付日",
                                        IkenshoConstants.FORMAT_ERA_YMD,
                                        tableCellRenderer, null) }));
...
//    }
    ...
    private boolean setSokatuPrtData(ACChotarouXMLWriter pd,
        ...
        case IkenshoConstants.IKENSHO_LOW_ISHI_IKENSHO:
        	...
        	IkenshoCommon.addString(pd, "lblTitle", "障害者総合支援法　医師意見書作成料・検査料請求（総括）書");
            break;
        }
...
//            pd.addFormat("syosai", dir + "IkenshoMeisai.xml");
        ...
        if ((printMode & KENSA_PRINT) == KENSA_PRINT) {
            ...
            // [ID:0000603][Masahiko Higuchi] 2010/03 add begin 診療報酬単価の変更対応
