...
//        printOptionGrp.add(pageHeaderPrintGrp2, VRLayout.CLIENT);
        ...
        // [ID:0000802][Ryosuke Koinuma] 2018/03 edit-Start 診療報酬単価の変更対応
//        // [ID:0000800][Ryosuke Koinuma] 2016/03 edit-Start 診療報酬単価の変更対応
//        rollBack.setText("H28年診療報酬単価(D)");
//        // [ID:0000800][Ryosuke Koinuma] 2016/03 edit-End
        rollBack.setText("H30年診療報酬単価(D)");
...
//                        "意見書作成料／診察・検査費用点数に"+ ACConstants.LINE_SEPARATOR + "H28年診療報酬単価を設定します。よろしいですか？",
//                        ACMessageBox.BUTTON_OKCANCEL,
//                        ACMessageBox.ICON_QUESTION, ACMessageBox.FOCUS_OK);
//                // [ID:0000800][Ryosuke Koinuma] 2016/03 edit-End
                int result = ACMessageBox.show(
                        "意見書作成料／診察・検査費用点数に"+ ACConstants.LINE_SEPARATOR + "H30年診療報酬単価を設定します。よろしいですか？",
                        ACMessageBox.BUTTON_OKCANCEL,
                        ACMessageBox.ICON_QUESTION, ACMessageBox.FOCUS_OK);
                // [ID:0000802][Ryosuke Koinuma] 2018/03 edit-End
...
//            kingakuTensuData.put("SHOSIN_HOSPITAL", new Double(270.0)); // 初診料(病院)
            ...
            // [ID:0000800][Ryosuke Koinuma] 2016/03 del-Start 平成28年診療報酬改定
...
//            // [ID:0000775][Masahiko Higuchi] 2014/03 add-End
            ...
            // [ID:0000802][Ryosuke Koinuma] 2018/03 del-Start 平成30年診療報酬改定       
//            // [ID:0000800][Ryosuke Koinuma] 2016/03 add-Start 平成28年診療報酬改定
//            kingakuTensuData.put("EXP_KS",new Double(25.0)); // 血液採取(静脈)
//            kingakuTensuData.put("EXP_KIK_MKI",new Double(21.0)); // 末梢血液一般検査
//            kingakuTensuData.put("EXP_KIK_KEKK",new Double(125.0)); // 血液学的検査判断料
//            kingakuTensuData.put("EXP_KKK_KKK",new Double(115.0)); // 血液化学検査(10項目以上)
//            kingakuTensuData.put("EXP_KKK_SKK",new Double(144.0)); // 生化学的検査(I)判断料
//            kingakuTensuData.put("EXP_NITK",new Double(26.0)); // 尿中一般物質定性判定量検査
//            kingakuTensuData.put("EXP_XRAY_TS",new Double(60.0)); // 単純撮影（アナログ）
//            kingakuTensuData.put("EXP_XRAY_TS_DIGITAL", new Double(68.0)); // 単純撮影（デジタル）
...
//            // [ID:0000800][Ryosuke Koinuma] 2016/03 add-End
            ...
            // [ID:0000802][Ryosuke Koinuma] 2018/03 add-Start 平成30年診療報酬改定
            kingakuTensuData.put("EXP_KS",new Double(30.0)); // 血液採取(静脈)
            kingakuTensuData.put("EXP_KIK_MKI",new Double(21.0)); // 末梢血液一般検査
            kingakuTensuData.put("EXP_KIK_KEKK",new Double(125.0)); // 血液学的検査判断料
            kingakuTensuData.put("EXP_KKK_KKK",new Double(112.0)); // 血液化学検査(10項目以上)
            kingakuTensuData.put("EXP_KKK_SKK",new Double(144.0)); // 生化学的検査(I)判断料
            kingakuTensuData.put("EXP_NITK",new Double(26.0)); // 尿中一般物質定性判定量検査
            kingakuTensuData.put("EXP_XRAY_TS",new Double(60.0)); // 単純撮影（アナログ）
            kingakuTensuData.put("EXP_XRAY_TS_DIGITAL", new Double(68.0)); // 単純撮影（デジタル）
            ...
            kingakuTensuData.put("EXP_XRAY_FILM",new Double(12.0));// フィルム(大角)
            kingakuTensuData.put("EXP_XRAY_DIGITAL_MANAGEMENT",new Double(57.0));// 電子画像管理加算
            kingakuTensuData.put("EXP_XRAY_DIGITAL_FILM",new Double(19));// 画像記録用フィルム(大角)
            kingakuTensuData.put("SHOSIN_SINRYOUJO", new Double(282.0)); // 初診料(診療所)
            kingakuTensuData.put("SHOSIN_HOSPITAL", new Double(282.0)); // 初診料(病院)
