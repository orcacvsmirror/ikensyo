...
//        printOptionGrp.add(pageHeaderPrintGrp2, VRLayout.CLIENT);
        ...
        //[ID:0000686][Masahiko Higuchi] 2012/03 edit begin 診療報酬単価の変更対応
        rollBack.setText("H24年診療報酬単価(D)");
    ...
    private void event() throws Exception {
        ...
        rollBack.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                // [ID:0000686][Masahiko Higuchi] 2010/03 edit begin 診療報酬単価の変更対応
                int result = ACMessageBox.show(
                        "意見書作成料／診察・検査費用点数に"+ ACConstants.LINE_SEPARATOR + "H24年診療報酬単価を設定します。よろしいですか？",
