...
import jp.or.med.orca.ikensho.affair.IkenshoReceiptApiSetting;
...
public class IkenshoCommon {
    ...
    // [ID:0000518][Tozo TANAKA] 2009/09/04 add begin
    // 【2009年度対応：特記事項一覧】特定疾病項目の編集を可能とする
    /** 特定疾病 */
    public static final int TEIKEI_SPECIFIED_DISEASE_NAME = 68;
    // [ID:0000518][Tozo TANAKA] 2009/09/04 add end
    // 【2009年度対応：特記事項一覧】特定疾病項目の編集を可能とする
     ...
     *             処理例外
     */
    public static void setComboModel(JComboBox combo, String field,
            String table, String codeField, int code, String orderField)
            throws Exception {
        IkenshoFirebirdDBManager dbm = new IkenshoFirebirdDBManager();
     ...
     *             SQL例外
     */
    public static VRHashMapArrayToConstKeyArrayAdapter geArrayAdapter(
            IkenshoFirebirdDBManager dbm, String field, String table,
            String codeField, int code, String orderField) throws SQLException {
     ...
     *             SQL例外
     */
    public static void setComboModel(IkenshoFirebirdDBManager dbm,
            JComboBox combo, String field, String table, String codeField,
     ...
     *             解析例外
     */
    public static void setHintButtons(IkenshoFirebirdDBManager dbm,
            String[] codes, int formatKubun, IkenshoHintButton[] buttons)
        ...
        for (int i = 0; i < end; i++) {
            ...
            if (array.getDataSize() > 0) {
                String[] sep = ACTextUtilities.separateLineWrapLimit(String
                        .valueOf(VRBindPathParser.get("TEIKEIBUN",
                                (VRMap) array.getData())), 2);
                // String[] sep =
                // String.valueOf(VRBindPathParser.get("TEIKEIBUN", (VRMap)
                // array.getData())).split(IkenshoConstants.LINE_SEPARATOR, 2);
                if (sep.length < 2) {
                    buttons[i].setHintTitle("");
                    buttons[i].setHintText(ACTextUtilities
                            .toBlankIfNull(sep[0]));
                } else {
     ...
     * @return 任意の列の値集合
     */
    public static VRHashMapArrayToConstKeyArrayAdapter getFieldRows(
            IkenshoFirebirdDBManager dbm, String field, String table,
            String codeField, int code, String orderField) throws SQLException {
        StringBuffer sb = new StringBuffer();
        sb.append("SELECT ");
        ...
        return new VRHashMapArrayToConstKeyArrayAdapter(
                (VRArrayList) dbm.executeQuery(sb.toString()), field);
    }
     ...
     *             処理例外
     */
    public static void setMInstitution(JComboBox combo, int institutionKbn)
            throws Exception {
        // String sql =
        // "SELECT INSTITUTION_NM FROM M_INSTITUTION WHERE INSTITUTION_KBN=" +
        // institutionKbn;
        // setComboModel(combo, sql, "INSTITUTION_NM");
        setComboModel(combo, "INSTITUTION_NM", "M_INSTITUTION",
                "INSTITUTION_KBN", institutionKbn, "");
    }
     ...
     *             処理例外
     */
    public static void setMInstitution(IkenshoFirebirdDBManager dbm,
            JComboBox combo, int institutionKbn) throws Exception {
        setComboModel(dbm, combo, "INSTITUTION_NM", "M_INSTITUTION",
                "INSTITUTION_KBN", institutionKbn, "");
    }
     ...
     *             処理例外
     */
    public static void setMDisease(JComboBox combo, int diseaseKbn)
            throws Exception {
        // String sql = "SELECT DISEASE_NM FROM M_DISEASE WHERE DISEASE_KBN=" +
        // diseaseKbn +
        // " ORDER BY DISEASE_CD ASC";
        setComboModel(combo, "DISEASE_NM", "M_DISEASE", "DISEASE_KBN",
                diseaseKbn, "DISEASE_CD ASC");
    }
     ...
     *             処理例外
     */
    public static void setMDisease(IkenshoFirebirdDBManager dbm,
            JComboBox combo, int diseaseKbn) throws Exception {
        setComboModel(dbm, combo, "DISEASE_NM", "M_DISEASE", "DISEASE_KBN",
                diseaseKbn, "DISEASE_CD ASC");
    }
     ...
     *             処理例外
     */
    public static VRHashMapArrayToConstKeyArrayAdapter getMDisease(
            IkenshoFirebirdDBManager dbm, int diseaseKbn) throws Exception {
        return geArrayAdapter(dbm, "DISEASE_NM", "M_DISEASE", "DISEASE_KBN",
                diseaseKbn, "DISEASE_CD ASC");
    }
     ...
     *            データアダプタ
     */
    public static void applyComboModel(JComboBox combo,
            VRHashMapArrayToConstKeyArrayAdapter adapter) {
     ...
     * @return コンボモデル
     */
    public static ACComboBoxModelAdapter createComboAdapter(
            VRHashMapArrayToConstKeyArrayAdapter adapter) {
     ...
     *             処理例外
     */
    public static void setMSinryouka(JComboBox combo, int sinryoukaKbn)
            throws Exception {
        // String sql = "SELECT SINRYOUKA_NM FROM M_SINRYOUKA WHERE
        // SINRYOUKA_KBN=" +
        // sinryoukaKbn +
        // " ORDER BY SINRYOUKA_CD ASC";
        setComboModel(combo, "SINRYOUKA_NM", "M_SINRYOUKA", "SINRYOUKA_KBN",
                sinryoukaKbn, "SINRYOUKA_CD ASC");
    }
     ...
     *             処理例外
     */
    public static void setMSinryouka(IkenshoFirebirdDBManager dbm,
            JComboBox combo, int sinryoukaKbn) throws Exception {
        setComboModel(dbm, combo, "SINRYOUKA_NM", "M_SINRYOUKA",
                "SINRYOUKA_KBN", sinryoukaKbn, "SINRYOUKA_CD ASC");
    }
     ...
     *             処理例外
     */
    public static void setTeikeibun(JComboBox combo, int tkbKbn)
            throws Exception {
        // String sql = "SELECT TEIKEIBUN FROM TEIKEIBUN WHERE TKB_KBN=" +
        // tkbKbn +
        // " ORDER BY TKB_CD";
        setComboModel(combo, "TEIKEIBUN", "TEIKEIBUN", "TKB_KBN", tkbKbn,
                "TKB_CD");
    }
     ...
     *             処理例外
     */
    public static void setTeikeibun(IkenshoFirebirdDBManager dbm,
            JComboBox combo, int tkbKbn) throws Exception {
        setComboModel(dbm, combo, "TEIKEIBUN", "TEIKEIBUN", "TKB_KBN", tkbKbn,
                "TKB_CD");
    }
     ...
     *             処理例外
     */
    public static VRHashMapArrayToConstKeyArrayAdapter getTeikeibun(
            IkenshoFirebirdDBManager dbm, int tkbKbn) throws Exception {
        return geArrayAdapter(dbm, "TEIKEIBUN", "TEIKEIBUN", "TKB_KBN", tkbKbn,
                "TKB_CD");
    }
     ...
     * @return int 比較結果
     */
    public static int getNewDocumentStatus(VRArrayList ikenshoData,
            int ikenshoIndex, String ikenshoCreateDateField,
            VRArrayList sijishoData, int sijishoIndex,
            String sijishoCreateDateField) throws ParseException {
        int useDoc = NEW_DOC_NONE;

        Date ikenshoDate = null;
        if (ikenshoData.getDataSize() > ikenshoIndex) {
            // 意見書が存在
            Object ikenObj = VRBindPathParser.get(ikenshoCreateDateField,
                    (VRBindSource) ikenshoData.getData(ikenshoIndex));
        ...
        if (sijishoData.getDataSize() > sijishoIndex) {
            // 指示書が存在
            Object sijiObj = VRBindPathParser.get(sijishoCreateDateField,
                    (VRBindSource) sijishoData.getData(sijishoIndex));
    ...
    public static boolean hasSameName(VRMap map) throws Exception {
        ...
        sb.append(String.valueOf(VRBindPathParser.get("PATIENT_NM", map))
                .replaceAll("'", "''"));
        sb.append("')");
        sb.append("AND(PATIENT.BIRTHDAY = '");
        sb.append(IkenshoConstants.FORMAT_YMD.format(VRBindPathParser.get(
                "BIRTHDAY", map)));
        sb.append("')");
     ...
     * @return String 判定結果
     */
    public static String getBrankOrFormatedDate(IkenshoEraDateTextField date,
            Format format) {
...
//            }
        ...
        copy.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (cb != null) {
                    StringSelection ss = new StringSelection(environment
                            .getText()
        ...
        if (errLine.indexOf("Firebird 1.0") >= 0) {
            ...
            errLine = "【calendar.xmlが存在しない】インストール先にcalendar.xmlが存在していません。再インストールしてください。";
                ...
                .indexOf("ArrayIndexOutOfBoundsException: Acrobat/Path at") >= 0) {
            errLine = "【PDFの設定に問題があります。】PDFの設定でAcrobat5.0以降のPDF閲覧ソフトが設定されているか確認してください。";

        } else if (errLine.indexOf("ACProperityXML.getValueAt") >= 0) {
            errLine = "【設定ファイルに問題があります。】PDFの設定もしくはデータベースの設定を確認してください。"
                    + ACConstants.LINE_SEPARATOR + "解消されない場合、再インストールしてください。";
            ...
            errLine = "【XMLの解析に失敗しました。】インストール先に日本語名フォルダが含まれていないか確認してください。";
                ...
                .indexOf("SAXParseException: Invalid byte 1 of 1-byte UTF-8 sequence.") >= 0) {
            errLine = "【XMLの解析に失敗しました。】インストール先に日本語名フォルダが含まれていないか確認してください。";
        ...
        detail.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if ((pnl != null) && (pnl.getParent() != null)) {
                    ...
                    // 要求されるサイズを計算
                    int newH = (int) Math.max(minimumSize.getHeight(),
                            pnl.getParent().getHeight() + newD.getHeight()
                                    - oldD.getHeight());
        ...
        if (environment.getPreferredSize().getWidth() > 600) {
            environment.setPreferredSize(new Dimension(600, (int) environment
    ...
    public static String getDBSafeString(String key, VRBindSource source)
            throws ParseException {
        return IkenshoConstants.FORMAT_PASSIVE_STRING.format(VRBindPathParser
                .get(key, source));
    }
    ...
    public static String getDBSafeDate(String key, VRBindSource source)
            throws ParseException {
        return IkenshoConstants.FORMAT_PASSIVE_YMD.format(VRBindPathParser.get(
                key, source));
    }
    ...
    public static String getDBSafeTime(String key, VRBindSource source)
            throws ParseException {
        return IkenshoConstants.FORMAT_PASSIVE_YMD_HMS.format(VRBindPathParser
                .get(key, source));
    }
    ...
    public static boolean isBillSeted(VRMap source) throws ParseException {
        if (VRBindPathParser.has("SHOSIN_TAISHOU", source)) {
            ...
            // final String[] checks = new String[]{"SHOSIN_TAISHOU",
            // "XRAY_TANJUN_SATUEI", "XRAY_SHASIN_SINDAN", "XRAY_FILM",
            // "BLD_SAISHU", "BLD_IPPAN_MASHOU_KETUEKI",
            // "BLD_IPPAN_EKIKAGAKUTEKIKENSA", "BLD_KAGAKU_KETUEKIKAGAKUKENSA",
            // "BLD_KAGAKU_SEIKAGAKUTEKIKENSA", "NYO_KENSA"};
            // TODO
            // final String[] checks = new String[]{"SHOSIN_TAISHOU",
            // "XRAY_TANJUN_SATUEI", "XRAY_SHASIN_SINDAN", "XRAY_FILM",
            // "XRAY_DIGITAL_MANAGEMENT", "XRAY_DIGITAL_FILM",
            // "XRAY_DIGITAL_IMAGING", "BLD_SAISHU", "BLD_IPPAN_MASHOU_KETUEKI",
            // "BLD_IPPAN_EKIKAGAKUTEKIKENSA", "BLD_KAGAKU_KETUEKIKAGAKUKENSA",
            // "BLD_KAGAKU_SEIKAGAKUTEKIKENSA", "NYO_KENSA"};
            final String[] checks = new String[] { "SHOSIN_TAISHOU",
                    "XRAY_TANJUN_SATUEI", "XRAY_SHASIN_SINDAN", "XRAY_FILM",
                    "XRAY_DIGITAL_MANAGEMENT", "XRAY_DIGITAL_FILM",
                    "XRAY_DIGITAL_IMAGING", "BLD_SAISHU",
                    "BLD_IPPAN_MASHOU_KETUEKI", "BLD_IPPAN_EKIKAGAKUTEKIKENSA",
                    "BLD_KAGAKU_KETUEKIKAGAKUKENSA",
                    "BLD_KAGAKU_SEIKAGAKUTEKIKENSA", "NYO_KENSA",
                    "XRAY_TANJUN_SATUEI_DIGITAL" };
            // TODO
            // 2009/01/09[Tozo Tanaka] : replace end
            final int end = checks.length;
            for (int i = 0; i < end; i++) {
                Integer pattern = (Integer) VRBindPathParser.get(checks[i],
                        source);
     ...
     * @return 出力したか
     */
    public static boolean addEraDate(ACChotarouXMLWriter pd, VRMap data,
            String key, String head, int wPos, int step) throws Exception {
     ...
     */
    public static boolean addEraDate(ACChotarouXMLWriter pd, VRMap data,
            String key, String head, int wPos, int step, String dateText)
            throws Exception {
        // 記入日
        ...
        if (obj instanceof Date) {
            ...
            // 月
            addString(pd, head + (wPos + step * 3),
                    VRDateParser.format(date, "MM"));
            addString(pd, head + (wPos + step * 4), "月");
            // 日
            addString(pd, head + (wPos + step * 5),
     ...
     * @return 出力したか
     */
    public static boolean addTel(ACChotarouXMLWriter pd, VRMap data,
            String key1, String key2, String target) throws Exception {
     ...
     */
    public static boolean addTel(ACChotarouXMLWriter pd, VRMap data,
            String key1, String key2, String target1, String target2,
            String target3) throws Exception {
        String tel1 = String.valueOf(VRBindPathParser.get(key1, data));
        String tel2 = String.valueOf(VRBindPathParser.get(key2, data));
     ...
     * @return 出力したか
     */
    public static boolean addZip(ACChotarouXMLWriter pd, VRMap data,
            String key, String target1, String target2) throws Exception {
        Object obj = VRBindPathParser.get(key, data);
        if (isNullText(obj)) {
            return false;
        }
     ...
     * @return 出力したか
     */
    public static boolean addSelection(ACChotarouXMLWriter pd, VRMap data,
            String key, String[] shaps, int offset) throws Exception {
        Object obj = VRBindPathParser.get(key, data);
     ...
     */
    public static boolean addSelection(ACChotarouXMLWriter pd, VRMap data,
            String key, String[] shaps, int offset, String optionKey,
     ...
     * @return 出力したか
     */
    public static boolean addString(ACChotarouXMLWriter pd, String target,
     ...
     * @return 出力したか
     */
    public static boolean addString(ACChotarouXMLWriter pd, VRMap data,
     ...
     */
    public static VRMap getMatchRow(VRArrayList array, String fieldName,
            VRBindSource source) throws ParseException {
     ...
     */
    public static boolean followComboIndex(VRArrayList array, String field,
            VRMap source, JComboBox combo) throws ParseException {
        if (array != null) {
     ...
     *             SQL例外
     */
    public static void setTax(IkenshoFirebirdDBManager dbm, VRMap map)
            throws SQLException {
        StringBuffer sb = new StringBuffer();
        sb = new StringBuffer();
        sb.append("SELECT");
     ...
     *             解析例外
     */
    public static void getMasterTable(IkenshoFirebirdDBManager dbm,
            HashMap dest, String nameField, String table, String codeField,
            String orderField) throws SQLException, ParseException {
            ...
            while (it.hasNext()) {
                ...
                dest.put(((Map.Entry) obj).getKey(),
                        new VRHashMapArrayToConstKeyArrayAdapter(
                                (VRArrayList) (((Map.Entry) obj).getValue()),
                                nameField));
            }
        }
    }
    ...
    public static int checkInsurerDoctorCheck() throws Exception {
        ...
        if (result.getDataSize() > 0) {
            insurers = ((Integer) VRBindPathParser.get("INSURER",
                    (VRMap) result.getData())).intValue();
        }
        sb = new StringBuffer();
        sb.append("SELECT");
        ...
        result = (VRArrayList) dbm.executeQuery(sb.toString());
        if (result.getDataSize() > 0) {
            doctors = ((Integer) VRBindPathParser.get("DOCTOR",
                    (VRMap) result.getData())).intValue();
        }
        dbm.finalize();
     ...
     * @param insurerData
     *            保険者一覧
     * @param nameTypeBindPath
     *            追加フィールド名
     */
    public static void buildInsureNameType(VRList insurerData,
            String nameTypeBindPath) throws Exception {
        ...
        while (it.hasNext()) {
            ...
            switch (ACCastUtilities.toInt(
                    VRBindPathParser.get("INSURER_TYPE", row), 0)) {
            case 1:
    ...
    public static boolean canAddIT(int formatKubun, boolean isDoctorAddIT,
            VRMap insurer) throws ParseException {
        return canAddIT(
                formatKubun,
                isDoctorAddIT,
                ACCastUtilities.toInt(
                        VRBindPathParser.get("SHOSIN_ADD_IT_TYPE", insurer), 1));
        // if(isDoctorAddIT){
        // //電子化加算ありの医療機関
        // switch(formatKubun){
